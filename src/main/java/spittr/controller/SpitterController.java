...
public class SpitterController {
	...
	private SpitterRepository spitterRepositry;
	private BaseRepository baseRepository ;

	@Autowired
	public SpitterController(SpitterRepository spitterRepositry, BaseRepository baseRepository)
	{
		this.spitterRepositry = spitterRepositry;
	...
	public String spitters(
			...
			Model model){
		List<Spitter> spitters = spitterRepositry.findSpitters(page, count);
...
//		return "redirect:/spitter/"+spitter.getUsername();  //重定向
			...
			Model model)
	{
		...
		{
			Spitter spitter = spitterRepositry.findByUsername(username);
			if (spitter == null)
