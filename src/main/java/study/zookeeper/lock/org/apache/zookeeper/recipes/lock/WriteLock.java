 ...
 */
package study.zookeeper.lock.org.apache.zookeeper.recipes.lock;
...
public class WriteLock extends ProtocolSupport {
     ...
     */
    public WriteLock(ZooKeeper zookeeper, String dir, List<ACL> acls) {
        super(zookeeper);
        this.dir = dir;
        if (acls != null) {
            setAcl(acls);
        ...
        private void findPrefixInChildren(String prefix, ZooKeeper zookeeper, String dir)
            ...
            for (String name : names) {
                if (name.startsWith(prefix)) {
                    //id按道理来说应该是要加上dir的，但这行代码一直没走到，官网没加dir
//                    id = name;
                    id = dir + "/" +name;
            ...
            do {
                ...
                if (id != null) {
                    ...
                    if (names.isEmpty()) {
                        ...
                        //保存该节点下的子节点，用排序辅助类取到最小序列的节点
                        // 并添加监听，监听那个节点的删除事件，取得他的锁
